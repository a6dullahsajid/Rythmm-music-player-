...
async function main() {
    ...
    let bsongfetch = await fetch("https://a6dullahsajid.github.io/Rythmm-music-player-/assets/bsongs/");
    ...
    let bimgfetch = await fetch("https://a6dullahsajid.github.io/Rythmm-music-player-/assets/bimgs/");
    ...
    // fetching rap songs
    let rapfetch = await fetch("https://a6dullahsajid.github.io/Rythmm-music-player-/assets/rapsongs/");
    ...
    let rapimgfetch = await fetch("https://a6dullahsajid.github.io/Rythmm-music-player-/assets/rapimgs/");
